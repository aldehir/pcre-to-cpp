            ...
            if (result.stl_success) {
                ...
                for (int i = 0; i < iterations; i++) {
                    try {
                        ...
                        result.stl_error = "exception during iterations";
                        break;
                    }
                }
                auto end = std::chrono::high_resolution_clock::now();
...
int main() {
    try {
        ...
        for (const auto & r : results) {
            ...
            result_json["tokens_match_pcre2"] = r.tokens_match_pcre2;
        ...
        summary["token_mismatches"] = token_mismatches;
        summary["all_passed"] = (token_mismatches == 0);
