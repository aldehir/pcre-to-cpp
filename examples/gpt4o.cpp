                    ...
                    for (size_t i0 = q0_count; i0 > 0; i0--) {
                        ...
                        for (size_t i1 = q1_count; i1 > 0; i1--) {
                            ...
                            for (size_t i2 = q2_count; i2 > 1; i2--) {
                                ...
                                size_t q3_count = _stack_count(q3_base);

                                // Try quantifier 3 positions longest-first (greedy, min_count=0)
                                for (size_t i3 = q3_count; i3 > 0; i3--) {
                                    match_pos = _stack_get(q3_base, i3);
                                    matched = true;
